...
export default function DVLABuildingDestructible({
  ...
  useFrame((state) => {
    ...
    if (mat) {
      ...
      const flicker =
        integrity < 0.5 ? Math.sin(t * 10) * 0.3 * (1 - integrity) : 0;
          ...
          >
            <mesh castShadow>
              ...
              <meshStandardMaterial
                color={
                  i % 3 === 0 ? "#6b7280" : i % 3 === 1 ? "#9ca3af" : "#4b5563"
                }
                roughness={0.9}
              />
            </mesh>
  ...
  return (
    <group ref={groupRef} {...props}>
      ...
      {!collapsedSections.has("front-1") && (
        ...
        >
          <mesh castShadow receiveShadow>
            <boxGeometry args={[8.0, 10.0, 26.0]} />
            <meshStandardMaterial
              color={bodyColor}
              roughness={0.8}
              transparent
      ...
      {!collapsedSections.has("tower-1") && (
        ...
        >
          <mesh>
            <boxGeometry args={[12.0, 15.0, 12.0]} />
      ...
      {!collapsedSections.has("base-1") && (
        ...
        >
          <mesh>
            <boxGeometry args={[16.0, 10.0, 26.0]} />
            <meshStandardMaterial transparent opacity={0} />
          </mesh>
        </RigidBody>
      )}
      ...
      {!collapsedSections.has("back-1") && (
        ...
        >
          <mesh>
            <boxGeometry args={[16.0, 10.0, 16.0]} />
            <meshStandardMaterial transparent opacity={0} />
          </mesh>
        </RigidBody>
      )}
      ...
      <RigidBody
        type="fixed"
        position={[0.19, 2.22, -72.91]}
        colliders="cuboid"
      >
        <mesh>
          <boxGeometry args={[16.0, 10.0, 4.0]} />
          <meshStandardMaterial transparent opacity={0} />
        </mesh>
      </RigidBody>
