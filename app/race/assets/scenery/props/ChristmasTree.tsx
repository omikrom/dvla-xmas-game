...
export function ChristmasTree({
  ...
  const tilt = destroyed ? -0.6 : THREE.MathUtils.degToRad((1 - integrity) * 15);
  ...
  const debrisPositions = useMemo(() => {
    ...
    return [
      ...
      { pos: [-0.5, 0.15, 0.3] as [number, number, number], size: [0.8, 0.15, 0.5] as [number, number, number], color: "#374151", rot: 0.8 },
      { pos: [0.6, 0.12, -0.2] as [number, number, number], size: [0.6, 0.12, 0.4] as [number, number, number], color: "#4b5563", rot: -0.5 },
      { pos: [0.1, 0.1, 0.6] as [number, number, number], size: [0.5, 0.1, 0.35] as [number, number, number], color: "#374151", rot: 1.2 },
      { pos: [-0.4, 0.08, -0.5] as [number, number, number], size: [0.7, 0.12, 0.4] as [number, number, number], color: "#4b5563", rot: -0.3 },
      // Trunk pieces
      { pos: [0.3, 0.2, 0.1] as [number, number, number], size: [0.25, 0.4, 0.2] as [number, number, number], color: "#5c4033", rot: 0.4 },
      { pos: [-0.2, 0.15, -0.3] as [number, number, number], size: [0.2, 0.35, 0.18] as [number, number, number], color: "#6b4423", rot: -0.7 },
    ];
  }, [destroyed]);
  ...
  const intact = (
    <group ref={groupRef} rotation={[tilt, 0, 0]}>
      ...
      ].slice(0, ornamentCount).map((orn, i) => (
        <mesh key={`orn-${i}`} position={orn.pos as [number, number, number]}>
  ...
  const toppled = (
    <group>
      ...
      {[
        ...
        <mesh key={`fallen-orn-${i}`} position={orn.pos as [number, number, number]}>
